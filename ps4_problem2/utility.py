...
class Utility:
    ...
    def assign_probability(prob_list):
        """takes a probability list of a player and makes a
        new list according to that and returns it
        input: a list of probabilities
        return: a list of probalities distributed from 1 to 100"""
        count_prob = 0
        prob_list_of_shots = []
    ...
    def score_run(inning, batsman_action):
        """
        procedure when batsman scores some runs either 0,1,2,3,4,5,6
